...
function Login() {
    return(
            ...
            <div class="flex justify-center items-center h-screen bg-gray"> {/*container*/}
                <div class="w-1/3 h-5/6 p-5 bg-light-purple flex flex-col items-center text-white"> {/*login-box*/}
                    <img src={logo} alt="logo" className="w-32 h-32 rounded-full"/>
                    <h2 class="mb-5">SignIn</h2>  
                    <form class="login-form w-full">
                        <label class="text-lg mb-1" for="username">Email</label>
                ...
                <div class="w-1/3 h-4/6 p-4 flex flex-col items-center bg-very-light-purple border-2 border-black rounded-3xl"> {/*register-box*/}
